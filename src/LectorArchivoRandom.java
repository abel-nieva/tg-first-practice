...
public class LectorArchivoRandom extends Object {
	 ...
	 */
	public LectorArchivoRandom(String nombreArchivo) throws FileNotFoundException
	{
	 ...
	 */
	public void generaContenido() throws IOException
	{
	...
	/**
	 * Lee el contenido del archivo asociado a la propiedad "archivo" y lo
	 * vuelca por pantalla. Se lee en el mismo orden/formato que se ha escrito
	 */
	public void volcar() throws IOException
	{
		...
		this.archivo.seek(0);
		// la lectura del fichero debe respetar el formato y el orden de los
		// tipos que se usaron para generar el contenido
		for (int i=0; i<2; i++){
	...
	// este método escribe el contenido del parámetro cadena, con tantos
	// caracteres como indica el segundo parámetro, en el archivo que se pasa
	// como tercer parámetro. Si cadena tiene menos bytes se rellena con
	// blancoas. Si cadena tiene más bytes se trunca su tamaño.
	...
	// este método lee del archivo que se pasa como segundo parámetro tantos
	// caracteres como indique el primer parámetro
